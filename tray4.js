...
const dayPRef = firebase.database().ref('tray4/day'); //  ngày
const monthRef = firebase.database().ref('tray4/month'); // tháng
const yearRef = firebase.database().ref('tray4/year'); // năm
