...
const dayPRef = firebase.database().ref('tray3/day'); //  ngày
const monthRef = firebase.database().ref('tray3/month'); // tháng
const yearRef = firebase.database().ref('tray3/year'); // năm
