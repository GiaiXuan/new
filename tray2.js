...
const dayPRef = firebase.database().ref('tray2/day'); //  ngày
const monthRef = firebase.database().ref('tray2/month'); // tháng
const yearRef = firebase.database().ref('tray2/year'); // năm
